...
@section('content')
 ...
 <h5>Enter your information</h5>
    ...
    <span class="input-group-text" id="basic-addon1">@</span>
            ...
            <div class="row">
                <div class="col">
                      <input type="tel" name="number" placeholder="Phone"  maxlength="12" minlength="10"  title="Ten digits code" value='{{$booking->number}}' required/>    
                 <label style="font-size:9px;padding-left:20px"> Eg : 081 222 2224  </label> 
                </div>
            </div>
            <br>
            <label class="my-2 mr-2" for="gender">Gender</label>
              <select class="custom-select mr-sm-2" id="gender" name='gender' value='{{$booking->gender}}'>
    ...
    <select class="custom-select " name="to" id="to"  onchange="validatePlace()" required value='{{$booking->to}}'>
  ...
  <select class="custom-select " name="from" id="from"  onchange="validatePlace()" required value='{{$booking->from}}'>
    <option selected>Choose...</option>
    <option value="Los Angeles">Los Angeles</option>
    <option value="Dubai">Dubai</option>
    <option value="London">Londan</option>
    ...
    <option value="Delhi">Delhi</option>
         ...
         <p class="loginError" id='loginError' style="display:none;color:red;">please enter your email address or password.</p>
                ...
                <input type="date" onchange="validateDate()" id="DeptDate" name="DeptDate" required value='{{$booking->DeptDate}}'>
                </div>
                        <div class="col">
                <label for="DeptTime">Departure Time:</label>
                <select class="custom-select mr-sm-2" id="DeptTime" name='DeptTime' required value='{{$booking->DeptTime}}'>
             ...
             <div class="form-row my-5 mx-2">
                  ...
                  <div class="form-group mx-2">
                            ...
                            <input type="number" id="tickets" name='tickets' class="form-control"  min="1" max='10'  required onchange="validateTickets()"  value='{{$booking->tickets}}'
                            ...
                            <input type="number" id="children" name='childrens' class="form-control" min="0" max='10'  required  value='{{$booking->childrens}}'
                                aria-describedby="passwordHelpInline">
                            <small id="passwordHelpInline" class="text-muted">
