...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
 ...
 <h5>Enter your information</h5>
            ...
            <div class="row">
                <div class="col">
                      <input type="tel" name="number" placeholder="888 888 8888"  maxlength="12" minlength="10"  title="Ten digits code" required/>    
  ...
  <datalist id="genders">
            ...
            <div class="form-row">
                ...
                <div class="col">
                 <label for="to">To:</label>
                    <input list="to's" name="to" id="to"  onchange="validatePlace()" required>
                      <datalist id="to's">
    ...
    <option value="Delhi">
                ...
                <div class="col">
                 <label for="from">From:</label>
                    ...
                    <input list="from's" name="from" id="from" onchange="validatePlace()"  required>
                                          <datalist id="from's">
    <option value="Los Angeles">
    <option value="Dubai">
    <option value="London">
    ...
    <option value="Delhi">
         ...
         <p class="loginError" id='loginError' style="display:none;color:red;">please enter your email address or password.</p>
                ...
                <input type="date" onchange="validateDate()" id="DeptDate" name="DeptDate">
                </div>
                        <div class="col">
                ...
                <div class="col">
                  ...
                  <div class="form-group">
                            ...
                            <input type="number" id="children" name='childrens' class="form-control mx-sm-3" min="0" max='10'  required 
                                aria-describedby="passwordHelpInline">
                            <small id="passwordHelpInline" class="text-muted">
